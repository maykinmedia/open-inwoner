...
class JaaropgaveClient(SSDBaseClient):
    ...
    def get_reports(
        ...
        from devtools.ssd import mock_get_jaaropgaven

        jaaropgaven = mock_get_jaaropgaven()
...
class UitkeringClient(SSDBaseClient):
    ...
    def get_reports(
        ...
        from devtools.ssd import mock_get_uitkeringen

        uitkeringen = mock_get_uitkeringen()
