...
class VersionTestCase(TestCase):
    def setUp(self):
        patched_subprocess = patch("open_inwoner.conf.utils.check_output")
        self.mocked_subprocess = patched_subprocess.start()

        patched_which = patch("open_inwoner.conf.utils.which")
...
class FileVersionTestCase(VersionTestCase):
    def setUp(self):
        ...
        patched_listdir = patch("open_inwoner.conf.utils.os.listdir")
