...
from open_inwoner.core.cms.cms_plugins.extensions.constants import (
    Icons,
    IndicatorChoices,
)
...
from open_inwoner.mijn_samenwerkingen.models import Plan, PlanContact
...
class PlanViewTests(WebTest):
    ...
    def test_plan_note_edit_saves_note_correctly(self):
        ...
        form["note"] = "Form-based test note."
    ...
    def test_plan_note_edit_contact_can_edit(self):
        ...
        self.assertEqual(response.status_code, 200)
        form = response.forms["note-edit"]
        form["note"] = "Note edited by contact user."
    ...
    def test_plan_action_edit(self):
        ...
        self.assertIn(
            _("Changed: {changed_fields}.").format(changed_fields=_("Action title")),
            body,
        )
