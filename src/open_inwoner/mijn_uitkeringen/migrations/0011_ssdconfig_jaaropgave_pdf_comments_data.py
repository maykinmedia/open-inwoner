...
migrate_jaaropgave_pdf_comments = partial(
    migrate_ssd_field, field_name="jaaropgave_pdf_comments", convert_markdown=False
)


class Migration(migrations.Migration):
    dependencies = [
        ("ssd", "0010_ssdconfig_jaaropgave_pdf_comments_schema_1"),
    ]

    operations = [
        migrations.RunPython(
            code=migrate_jaaropgave_pdf_comments,
