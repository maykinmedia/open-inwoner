...
from open_inwoner.mijn_uitkeringen.client import UitkeringClient
from open_inwoner.mijn_uitkeringen.tests.factories import SSDConfigFactory
from open_inwoner.mijn_uitkeringen.tests.mocks import (
...
class TestMonthlyBenefitsFormView(TestCase):
    ...
    @patch(
        "open_inwoner.mijn_uitkeringen.client.UitkeringClient.get_reports",
        return_value=None,
    )
    @freeze_time("1985-12-25")
    ...
    @patch("open_inwoner.mijn_uitkeringen.models.SSDConfig.get_solo")
...
class TestYearlyBenefitsFormView(TestCase):
    ...
    @patch(
        "open_inwoner.mijn_uitkeringen.client.JaaropgaveClient.get_reports",
        return_value=None,
    )
    @freeze_time("1985-12-25")
    ...
    @patch("open_inwoner.mijn_uitkeringen.forms.SSDConfig.get_solo")
