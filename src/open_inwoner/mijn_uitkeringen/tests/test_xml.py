...
from open_inwoner.mijn_uitkeringen.service.jaaropgave import JaarOpgaveInfoResponse
from open_inwoner.mijn_uitkeringen.service.uitkering import (
    UitkeringsSpecificatieInfoResponse as UitkeringInfoResponse,
)
from open_inwoner.mijn_uitkeringen.templatetags.ssd_tags import (
    format_currency,
...
from open_inwoner.mijn_uitkeringen.xml import get_jaaropgaven, get_uitkeringen
...
class JaaropgaveDataTest(TestCase):
    @patch("open_inwoner.mijn_uitkeringen.xml._get_report_info")
