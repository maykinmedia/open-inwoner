...
# TODO this setting is currently also used to determine whether or not to display
# the DigiD login link in the template, that should probably be replace by a flag on the
# SiteConfiguration
