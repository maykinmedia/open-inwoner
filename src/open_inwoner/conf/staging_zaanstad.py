...
os.environ.setdefault("CACHE_DEFAULT", "127.0.0.1:6379/10")
...
os.environ.setdefault("ES_INDEX_PRODUCTS", "products-zaanstad")
os.environ.setdefault("MEDIA_SUBFOLDER", "zaanstad")
