...
@override_settings(
    ...
    KLANTEN_API_ROOT=KLANTEN_API_ROOT,
    KLANTEN_API_CLIENT_ID="open-inwoner-test",
    KLANTEN_API_SECRET="klanten-secret",
    CONTACTMOMENTEN_API_ROOT=CONTACTMOMENTEN_API_ROOT,
    CONTACTMOMENTEN_API_CLIENT_ID="open-inwoner-test",
    CONTACTMOMENTEN_API_SECRET="contactmomenten-secret",
    ...
    KIC_USE_RSIN_FOR_INNNNPID_QUERY_PARAMETER=False,
)
