...
from open_inwoner.mijn_aanvragen.models import OpenZaakConfig, ZaakTypeConfig
from open_inwoner.onderwerpen.models import Category, CategoryProduct
from open_inwoner.onderwerpen.resources import (
