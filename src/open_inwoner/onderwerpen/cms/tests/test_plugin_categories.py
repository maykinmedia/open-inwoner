...
from open_inwoner.onderwerpen.cms.cms_plugins import CategoriesPlugin
...
class TestHighlightedCategories(WebTest):
    ...
    @patch("open_inwoner.mijn_aanvragen.models.OpenZaakConfig.get_solo")
...
class TestCategoriesCaseFiltering(ClearCachesMixin, TransactionWebTest):
    ...
    def test_categories_based_on_selected_categories(self, m):
        ...
        # Use non order-dependent set comparison
        self.assertEqual(set(context["categories"]), {self.category1, self.category2})
