...
class InnerCaseDetailView(
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.case:
            ...
            # eSuite-specific workaround to deal with multiple statustypes per zaaktype having isEindstatus: true
            if statuses and statuses[-1].statustype and statuses[-1].statustype.is_eindstatus:
