...
from open_inwoner.mijnzaken.views import InnerCaseDetailView, SimpleFile
...
class TestCaseDetailView(
    ...
    @patch(
        "open_inwoner.mijnzaken.views.OpenKlant2Service",
    ...
    @patch(
        "open_inwoner.mijnzaken.views.InnerCaseDetailView.is_file_upload_enabled_for_statustype",
        autospec=True,
    )
    ...
    @patch(
        "open_inwoner.mijnzaken.views.InnerCaseDetailView.is_internal_file_upload_enabled",
        autospec=True,
    )
