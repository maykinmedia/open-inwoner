...
class FetchZakenForCompanyTests(TestCase):
    ...
    def test_raises_value_error_when_neither_kvk_nor_vestigingsnummer_given(self, m):
        with self.assertRaises(ValueError):
            self.zaken_client.fetch_cases_for_company()
    ...
    def test_sends_only_vestigingsnummer_when_only_vestigingsnummer_provided(self, m):
        ...
        self.zaken_client.fetch_cases_for_company(vestigingsnummer="987654321")
    ...
    def test_sends_only_kvk_when_only_kvk_provided(self, m):
        ...
        self.zaken_client.fetch_cases_for_company(kvk_or_rsin="12345678")
    ...
    def test_fetch_cases_sends_both_kvk_and_vestigingsnummer_when_both_provided(
        self, m
    ):
        m.get(
            f"{ZAKEN_ROOT}zaken",
        ...
        self.zaken_client.fetch_cases(user_kvk="12345678", vestigingsnummer="987654321")
