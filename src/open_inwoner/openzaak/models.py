...
class OpenZaakConfig(SingletonModel):
    ...
    use_zaak_omschrijving_as_title = models.BooleanField(
        verbose_name=_(
            "Make use of zaak.omschrijving for the title of the cases instead of zaaktype.omschrijving (eSuite)"
        ),
        help_text=_(
            "If enabled, we use zaak.omschrijving for the title of the cases, and use zaaktype.omschrijving as a fallback in case it is not filled in"
