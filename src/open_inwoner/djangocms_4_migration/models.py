...
class PageData(models.Model):
    ...
    creation_date = models.DateTimeField(
        "creation date", editable=False, blank=True, null=True
    )
    ...
    opposite_number_id = models.CharField(
        "publisher public id", max_length=20, blank=True, null=True
    )

    # page details
    page_id = models.CharField("page id", max_length=50)
    # This is the opposite and called publisher_public_id in CMS 3.5 which is confusing as a published page points at a draft
    page_opposite_number_id = models.CharField(
        "publisher public id", max_length=20, blank=True, null=True
    )
