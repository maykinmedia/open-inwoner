...
from open_inwoner.mijn_aanvragen.api_models import Notification
from open_inwoner.mijn_aanvragen.auth import get_valid_subscriptions_from_bearer
from open_inwoner.mijn_aanvragen.exceptions import (
    InvalidAuth,
    InvalidAuthForClientID,
    NoSubscriptionForClientID,
)
from open_inwoner.mijn_aanvragen.tests.factories import SubscriptionFactory
...
@override_settings(CELERY_TASK_ALWAYS_EAGER=True, CELERY_TASK_EAGER_PROPAGATES=True)
@patch("open_inwoner.mijn_aanvragen.tasks.handle_zaken_notification", autospec=True)
