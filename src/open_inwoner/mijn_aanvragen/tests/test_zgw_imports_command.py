...
from open_inwoner.mijn_aanvragen.tests.test_zgw_imports import CatalogMockData
...
class ZGWImportCommandWithoutConfigTest(TestCase):
    @mock.patch(
        "open_inwoner.mijn_aanvragen.management.commands.zgw_import_data.ZGWCatalogusImporter"
    )
