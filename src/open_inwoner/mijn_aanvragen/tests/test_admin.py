...
from open_inwoner.mijn_aanvragen.api_models import ResultaatType
...
class TestZaakTypeConfigAdmin(WebTest):
    ...
    @mock.patch("open_inwoner.mijn_aanvragen.admin.build_zgw_client_from_service")
...
class TestCatalogusConfigExportAdmin(WebTest):
    ...
    @mock.patch(
        "open_inwoner.mijn_aanvragen.import_export.ZGWConfigImport.import_from_jsonl_file_in_django_storage"
    )
