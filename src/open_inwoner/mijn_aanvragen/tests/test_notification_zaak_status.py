...
from open_inwoner.mijn_aanvragen.api_models import Status, StatusType, Zaak, ZaakType
from open_inwoner.mijn_aanvragen.models import (
    OpenZaakConfig,
    UserCaseStatusNotification,
)
from open_inwoner.mijn_aanvragen.notifications import (
...
@patch("open_inwoner.mijn_aanvragen.notifications._handle_status_update", autospec=True)
...
class NotificationHandlerUserMessageTestCase(AssertTimelineLogMixin, TestCase):
    ...
    @patch(
        "open_inwoner.mijn_aanvragen.notifications.send_case_update_email",
        autospec=True,
    )
