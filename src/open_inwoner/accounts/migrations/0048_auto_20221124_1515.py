...
def populate_user_contacts(apps, schema_editor):
    ...
    for contact in MyModel.objects.exclude(contact_user__isnull=True):
        ...
        contact_user.first_name = contact.first_name
        contact_user.last_name = contact.last_name
        contact_user.phonenumber = contact.phonenumber
        contact_user.function = contact.function
        contact_user.save()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("accounts", "0047_auto_20221124_1515"),
