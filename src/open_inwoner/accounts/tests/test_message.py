...
class MessageTest(TestCase):
    def setUp(self):
        self.sender = UserFactory.create(first_name="Person", last_name="A", email="person-a@example.com")
        self.receiver = UserFactory.create(first_name="Person", last_name="B", email="person-b@example.com")
    ...
    def test_str(self):
        ...
        self.assertEqual(str(message), "From: person-a@example.com, To: person-b@example.com (2021-12-21)")
        message.delete()

    @freeze_time('2021-12-21 17:22:57')
    def test_as_message_type(self):
        message = MessageFactory(sender=self.sender, receiver=self.receiver, content="Lorem ipsum.")
