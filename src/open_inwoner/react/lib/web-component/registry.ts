...
import { HOMEPAGE_PLUGIN_SECTION_DEFINITION } from '@react/components/HomepagePluginSection/constants';
import { LOADING_SPINNER_DEFINITION } from '@react/components/Spinner/constants';
import { HOME_PLUGIN_CARD_ITEM_DEFINITION } from '@react/components/HomePluginCardItem';
...
export const WEB_COMPONENT_REGISTRY = {
  ...
  [HOMEPAGE_PLUGIN_SECTION_DEFINITION.tagName]:
