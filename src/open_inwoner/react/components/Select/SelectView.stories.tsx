...
/**
 * SelectView visual states — exercised through oip-select so the full shadow DOM
 * stack (SelectView + useSelectProvider + SelectOption) is in play.
 */

const meta: Meta = {
  title: 'Debug/SelectView',
  decorators: [
