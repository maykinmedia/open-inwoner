...
class TestListItem(InclusionTagWebTest):
    ...
    def test_message_days(self):
        self.assertTextContent('.messages__day:nth-child(1) .message .message__body', 'Lorem ipsum.', self.config)
        self.assertTextContent('.messages__day:nth-child(2) .message .message__body', 'Dolor sit amet.', self.config)
        self.assertTextContent('.messages__day:nth-child(3) .message .message__body', 'Consectetur adipiscing elit.', self.config)
