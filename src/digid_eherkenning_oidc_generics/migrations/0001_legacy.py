"""
Squashed migration that encapsulates the legacy digid_eherkenning_oidc_generics app.

In preparation of swapping out this package to digid_eherkenning.oidc, migrations
are squashed to get a clear picture of the state of DB/models so that we can explicitly
define the models/fields and remove any inheritance, which makes upgrading the
underlying libraries much more feasible.

The end goal is that we can copy over the configuration to the models shipped in the
digid-eherkenning library.
"""

# Generated by Django 4.2.11 on 2024-07-05 21:21
...
class Migration(migrations.Migration):
    ...
    replaces = [
        ...
        (
            "digid_eherkenning_oidc_generics_legacy",
            "0004_alter_openidconnectdigidconfig_table_and_more",
        ),
    ]
