...
export default function Register() {
    ...
    const registerUser = async (email?: string, password1?: string, password2?: string, firstName?: string, lastName?: string) => {
        try {
            const res = await axios.post('http://localhost:8000/api/auth/registration/', {email: email, password1: password1, password2: password2, firstName: firstName, lastName: lastName}).catch(err => {
